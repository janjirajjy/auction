...
while($row = mysqli_fetch_array($result)) { 
  ...
  <a href='product.php?ID=$row[0]&act=open' class='btn btn-info btn-xs'>OPEN</a>
  </td> ";

  //แก้ไขข้อมูล
  echo "<td align='center'>
  <a href='product.php?ID=$row[0]&act=edit' class='btn btn-warning btn-xs'>edit</a></td> ";
  
  //ลบข้อมูล
  echo "<td align='center'>
  <a href='product_del_db.php?id=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'>del</a></td> ";
